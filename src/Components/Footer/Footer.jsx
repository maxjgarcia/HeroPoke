...
const Footer = () => {
  return (
    <>
      ...
      <footer className="w-full mx-auto flex flex-col bg-black/90 text-white/60">
        <div className="w-full draggable">
          <div className="container flex flex-col mx-auto">
            <div className="flex flex-col items-center w-full my-10">
              <span className="mb-8">
                <img src={Logo} alt="Pokemon logo" className="w-auto h-36" />
              </span>

              <div className="flex flex-col items-center gap-6 mb-8">
                <div className="flex flex-wrap items-center justify-center gap-5 lg:gap-12 gap-y-3 lg:flex-nowrap text-dark-grey-900">
                  <a href="" className="text-white/60 hover:text-yellow-300">
                    About
                  </a>
                  <a href="" className="text-white/60 hover:text-yellow-300">
                    Features
                ...
                <div className="flex items-center gap-8">
                  <a href="" className="text-grey-700 hover:text-yellow-300">
                    <svg
              ...
              <div className="flex items-center space-x-2">
                <img src={Pokeball} alt="" className="w-[13px]" />
                <p className="text-base font-normal leading-7 text-center">
                  Pokémon page made for practice purposes
                </p>
                <img src={Pokeball} alt="" className="w-[13px]" />
              </div>
            </div>
